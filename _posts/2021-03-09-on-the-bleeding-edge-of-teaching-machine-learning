...
The idea was that I had certain things I wanted out of the project, and I allocated 60 of 100 points to those things. The other 40 points were theirs to play with and they did not play with them. This is fine. Perhaps in the future, I would give the students the full 100 points to play with and make it a design exercise in the Think-Pair-Share model.
